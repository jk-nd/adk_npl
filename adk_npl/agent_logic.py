"""
Shared agent logic and instructions for ADK-NPL agents.

This implements the NPL-Assisted Active Agent Architecture:
- Agents are ACTIVE goal-pursuers (not passive reactors)
- NPL provides STATE AWARENESS (what can I do?)
- A2A enables NEGOTIATION (natural language convergence)
- NPL prevents MISTAKES (validates actions)
"""
