"""
NPL Notification Tests

Tests for NPL notification flow:
- Notifications are emitted on state transitions
- Notification listener receives and parses SSE events
- Dispatch routes notifications to correct agent
